    ...
    <Container title="IT Engineering Services | Endure Consulting">
      <Layout>
        ...
        <Features maxCols={2}>
          ...
          <Features.Item bullets={["CI/CD & Continuous Monitoring", "Version Control," "Infrastructure as Code", "Configuration Management,"]}>
            Cloud Architecture, Security and Administration</Features.Item>
          <Features.Item>DevOps
          </Features.Item>
        </Features>
      </Layout>
    </Container>
